...
## B-33. 정성적 의료 주장(부작용·위험) 접지 fence 부재 `[✅ DONE 2026-07-12]`
> 해결: risk 한 줄(검증 안 된 LLM 스캐폴딩)을 삭제하고, **openFDA SPL 경고섹션을 제품당 verbatim 접지**(warnings.json)해 LabelWarnings 카드로 렌더 + 부작용 질문 라우팅("기억 나열 금지, 라벨 카드로 접지·defer"). D40. 아래는 원 기록.
